...
import { X, Send, Mic, Edit3, Coffee, Sunrise, Sun, Moon, Apple, Salad } from 'lucide-react';
...
const mealSuggestions = [
  { icon: Coffee, label: 'Coffee & Pastry', bg: 'bg-amber-100', color: 'text-amber-600' },
  { icon: Sunrise, label: 'Breakfast Bowl', bg: 'bg-yellow-100', color: 'text-yellow-600' },
  { icon: Sun, label: 'Healthy Lunch', bg: 'bg-orange-100', color: 'text-orange-600' },
  { icon: Salad, label: 'Light Snack', bg: 'bg-green-100', color: 'text-green-600' }
];
            ...
            >
              ...
              <div className="mb-4">
                ...
                >
                  <p style={{ color: 'var(--text-primary)' }}>
                    What meal would you like to add to your nutrition plan?
                  </p>
                </div>
              ...
              >
                <textarea
                  ...
                  className="w-full rounded-2xl px-4 py-3 pr-20 resize-none focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all min-h-[48px] max-h-32"
                  style={{
                ...
                <div className="absolute right-2 bottom-2 flex items-center gap-1">
                  ...
                  <motion.button
                    ...
                    className="p-2 rounded-xl transition-colors"
                    style={{
                      backgroundColor: aiInput.trim() ? '#10B981' : 'transparent',
